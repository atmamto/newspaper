    ...
    <div class="row" style="margin-top:30px;">
        ...
        <div class="col-md-12" style="border:1px solid #ccc; padding:15px 15px 30px 0px;">
        	...
        	<div class="col-md-6">
                ...
                <a href="{{url('article')}}/{{$g->slug}}"> Read more &raquo;
        ...
        <div class="row">
            ...
            <div class="col-md-12" style="border:1px solid #ccc; padding-bottom:30px;">
                ...
                <h3 style="border-bottom:3px solid #b952c8; padding-bottom:5px;"><span style="padding:6px 12px; background:#b952c8;">SPORTS</span></h3>
                    ...
                    <a href="{{url('article')}}/{{$s->slug}}"> Read more &raquo;
                        <span class="glyphicon glyphicon-chevron-right"></span><span class="glyphicon glyphicon-chevron-right"></span>
                    </a>
                    @endif
                    @endforeach
            ...
            <div class="col-md-12" style="border:1px solid #ccc; padding-bottom:30px;">
                ...
                <h3 style="border-bottom:3px solid #d95757; padding-bottom:5px;"><span style="padding:6px 12px; background:#d95757;">TECHNOLOGY</span></h3>
                    ...
                    <a href="{{url('article')}}/{{$t->slug}}"> Read more &raquo;
                        <span class="glyphicon glyphicon-chevron-right"></span><span class="glyphicon glyphicon-chevron-right"></span>
                    </a>
                    @endif
                    @endforeach
        ...
        <div class="col-md-12">
        	...
        	<div class="col-md-6">
            	 @foreach($health as $key=>$h)
                    ...
                    <a href="{{url('article')}}/{{$h->slug}}"> Read more &raquo;
                        <span class="glyphicon glyphicon-chevron-right"></span><span class="glyphicon glyphicon-chevron-right"></span>
                    </a>
                    @endif
                    @endforeach
                ...
                <div class="flex">
                    ...
                    <div>
                       <a href="{{url('article')}}/{{$tr->slug}}">
                        <img src="{{url('public/posts')}}/{{$tr->image}}" />
                       </a>
                    </div>
                    @endforeach
                </div>
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-6">
                 @foreach($entertainment as $key=>$en)
                    @if($key == 0)
                    <a href="{{url('article')}}/{{$en->slug}}">
                      <img src="{{url('public/posts')}}/{{$en->image}}" width="100%" style="margin-bottom:15px;" />
                    </a>
                    <h3><a href="{{url('article')}}/{{$en->slug}}">{{$en->title}}</a></h3>
                    <p align="justify">{!! substr($en->description,0,300) !!}</p> 
                    <a href="{{url('article')}}/{{$en->slug}}"> Read more &raquo;
                        <span class="glyphicon glyphicon-chevron-right"></span><span class="glyphicon glyphicon-chevron-right"></span>
                    </a>
                    @endif
                    @endforeach
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-12" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            <h4><a href="{{url('article')}}/{{$en->slug}}">{{$en->title}}</a></h4>
                        </div>
                    </div>
                </div>
                @endif
            ...
            @if($key == 0 && $key < 10)
          	<div class="col-md-12" style="border-bottom:1px solid #ccc; padding:0px 10px 20px 10px; margin-bottom:10px;">
           		<h3 style="border-bottom:3px solid #2b99ca; padding-bottom:5px;"><span style="padding:6px 12px; background:#2b99ca;">STYLE</span></h3>
                    ...
                    <a href="{{url('article')}}/{{$st->slug}}"> <img src="{{url('public/posts')}}/{{$st->image}}" width="100%" style="margin-bottom:15px;" /></a>
            ...
            @endforeach
             ...
             @if($key == 0 && $key < 10)
                <div class="col-md-12" style="border-bottom:1px solid #ccc; padding-bottom:10px; margin-bottom:10px;">
	            	<div class="col-md-4">
                    	<div class="row">
    	            		<img src="{{url('public/posts')}}/{{$st->image}}" width="100%" style="margin-left:-15px;" />
        	        	</div>
                    </div>
            	    <div class="col-md-8">
