...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-sm-12">
			<div class="row">
				<form method="post" action="<?php echo e(url('updatepage')); ?>/<?php echo e($data->pageid); ?>">
					<?php echo e(csrf_field()); ?>


					<input type="hidden" name="tbl" value="<?php echo e(encrypt('pages')); ?>">
					<input type="hidden" name="pageid" value="<?php echo e($data->pageid); ?>">
					<div class="col-sm-9">
