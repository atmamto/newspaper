...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-sm-4 cat-form">
			...
			<?php endif; ?>
			<h3>Edit Category</h3>
			<form method="post" action="<?php echo e(url('updatecategory')); ?>/<?php echo e($singledata->cid); ?>">
				<?php echo e(csrf_field()); ?>

				<input type="hidden" name="tbl" value="<?php echo e(encrypt('categories')); ?>">
				<input type="hidden" name="cid" value="<?php echo e($singledata->cid); ?>">
				<div class="form-group">
					<label>Name</label>
					<input type="text" name="title" id="category_name" class="form-control" 
					value="<?php echo e($singledata->title); ?>">
				...
				<div class="form-group">
					...
					value="<?php echo e($singledata->slug); ?>">
				...
				<div class="form-group">
					...
					<select class="form-control" name="status">
						<option><?php echo e($singledata->status); ?></option>
						<?php if( $singledata->status == 'off' ): ?>
						<option>on</option>
						<?php else: ?>
						<option>off</option>
						<?php endif; ?>
